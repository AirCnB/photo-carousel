...
const Share = ({ toggleShareView }) => {
  ...
  return (
    <div className={styles.sharepopup} role="presentation" onClick={() => toggleShareView()}>
      <div className={styles.sharepopupinner} role="presentation" onClick={stopProp}>
        <div className={styles.exitsharediv}>
          <svg onClick={() => toggleShareView()} className={styles.exitshare} viewBox="0 0 24 24">
        ...
        <div className={styles.subtitle}>
          Check out this awesome listing on Airbnb: Coastal Dream House Available for Rent
        </div>
        <div className={styles.sharelink}>
          <div className={styles.outershare}>
            ...
            <div className={styles.sharewebsite}>
              Facebook
            </div>
          </div>
        </div>
