...
const Share = ({toggleShareView}) => {
  ...
  return (
    <div className="sharepopup" onClick={ () => toggleShareView() } >
      <div className="sharepopupinner" onClick={ stopProp } >
        <div className="exitsharediv">
          <svg onClick={ () => toggleShareView() } className="exitshare" viewBox="0 0 24 24" >
        ...
        <div className="subtitle" >Check out this awesome listing on Airbnb: Coastal Dream House Available for Rent</div>
        <div className="sharelink">
          <div className="outershare">
            ...
            <div className="sharewebsite" >Facebook</div>
          </div>
        </div>
        <div className="sharelink">
          <div className="outershare">
            ...
            <div className="sharewebsite" >Twitter</div>
          </div>
        </div>
        <div className="sharelink">
          <div className="outershare">
        ...
        <div className="sharelink">
          <div className="outershare">
            <div className="shareicon">
              <svg viewBox="0 0 32 32" >
                <path d="m17.59 19.95-4.07-4.35-7.95 4.35 8.74-9.28 4.17 4.35 7.85-4.35zm-1.59-19.95c-8.84 0-16 6.63-16 14.82 0 4.66 2.33 8.82 5.96 11.54v5.64l5.45-2.99a17.24 17.24 0 0 0 4.59.62c8.84 0 16-6.63 16-14.82 0-8.18-7.16-14.81-16-14.81z" fillRule="evenodd"></path>
              </svg>
            </div>
            <div className="sharewebsite" >Messenger</div>
          </div>
        </div>
        <div className="sharelink">
          <div className="outershare">
            ...
            <div className="sharewebsite" >Copy Link</div>
          </div>
        </div>
        <div className="sharelink">
          <div className="outershare">
            ...
            <div className="sharewebsite" >Embed</div>
          </div>
        </div>
      </div>
    </div>
