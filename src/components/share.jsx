...
const Share = ({ toggleShareView }) => {
  ...
  return (
    <div className="sharepopup" role="presentation" onClick={() => toggleShareView()}>
      <div className="sharepopupinner" role="presentation" onClick={stopProp}>
